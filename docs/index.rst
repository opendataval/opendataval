...
#################################
Open Data Valuation documentation
#################################
...
**Useful links**:
`Installation <https://github.com/opendataval/opendataval/#hourglass_flowing_sand-installation>`_ |
...
`Releases <https://github.com/opendataval/opendataval/issues>`_
